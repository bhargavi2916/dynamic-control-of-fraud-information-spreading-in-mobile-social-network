...
<%@ page import="java.text.SimpleDateFormat, java.util.Date"%>
			...
			String upname=request.getParameter("upname");
			 ...
			 String query="select * from posts where pname='"+pname+"' "; 
				...
				if ( rs.next() )
			   {
					...
					int l=v+1;
						...
						String sql3="update posts set score="+l+" where pname='"+pname+"' ";
						Statement stmt3 = connection.createStatement();
						stmt3.executeUpdate(sql3);	
			}
			%>
            <h2>Liked !!!  <a href="U_View_All_Friends_Posts.jsp">Back</a></h2>
			</div>
      <div class="sidebar">
