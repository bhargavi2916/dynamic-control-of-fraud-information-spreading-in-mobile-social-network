     ...
     try
	{
			...
			if(value.equalsIgnoreCase("userlogin"))
			{
					...
					if (rs.next()==true) 
					{
								...
								String sql1="SELECT * FROM user where username='"+username+"' and status='Authorized' and bstatus='Unblocked' ";
								...
								else
								{
									...
									<br/>
									<p align="center" class="style3">You are not Authorized Or Blocked by  Admin, Please wait!! </p>
