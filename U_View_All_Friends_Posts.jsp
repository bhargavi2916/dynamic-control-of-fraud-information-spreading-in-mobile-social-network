...
-->
            ...
            <p align="center" class="style3">VIEW ALL MY FRIENDS POSTS !!! </p>
  ...
  <tr>
   ...
   <td width="101" height="32" bgcolor="#FF0000"><div align="center" style="color:#FFFF00"><b>Post Image</b></div></td>
    ...
    <td width="78" bgcolor="#FF0000"><div align="center" style="color:#FFFF00"><b>Post Description</b></div></td>
    ...
    <td width="33" bgcolor="#FF0000"><div align="center" style="color:#FFFF00"><strong>Post Likes </strong></div></td>
    <td width="62" bgcolor="#FF0000"><div align="center" style="color:#FFFF00"><b>Post Date</b></div></td>
	<td width="62" bgcolor="#FF0000"><div align="center" style="color:#FFFF00"><b>Review Post</b></div></td>
	<td width="62" bgcolor="#FF0000"><div align="center" style="color:#FFFF00"><b>Like</b></div></td>
		  </tr>
...
<%
	...
	while ( rs.next() )
	   {
		...
		j++;
			...
			String sql1 = "select requestfrom,requestto from req_res where ((requestfrom ='"+uname+"' && requestto='"+s8+"') ||(requestfrom ='"+s8+"' && requestto='"+uname+"'))and status ='Accepted' ";
  ...
  <tr>
    ...
    <td><div align="center" style="color:#FF0000"><%=s2%></div></td>
     <td><div align="center" style="color:#FF0000"><%=decryptedDes%></div></td>
			   ...
			   <td><div align="center" style="color:#FF0000"><a href="U_Review.jsp??id=<%=i%>&amp;pname=<%=s1%>&upname=<%=s8%>">Click to Review</a></div></td>
			   <td><div align="center" style="color:#FF0000"><a href="U_Like.jsp??id=<%=i%>&amp;pname=<%=s1%>&upname=<%=s8%>">Click to Like</a></div></td>
  </tr>
