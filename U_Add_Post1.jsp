...
-->
        ...
        <p align="center" class="style7 style9 style2" >T<strong>his Post is Already Uploaded By You.</strong>.</p>
              <%
					   }
					   else
					   {		
  ...
  PreparedStatement ps=connection.prepareStatement("insert into  posts(pname,puses,pdesc,pspl,psens,uname,date,image,score) values (?,?,?,?,?,?,?,?,?)"); 
		...
		%>
                  ...
                  <h3 >&nbsp;</h3>
                  <h3 align="center" class="style8 style7 style1" >Post Created Sucessfully!</h3>
                  <p class="style30">&nbsp;</p>
                  </p>
                  <div align="center">
  <%
