...
-->
             ...
             <form action="U_Add_Post1.jsp" method="post" enctype="multipart/form-data" name="s" target="_top" id="s" onSubmit="return valid()"  ons="ons">
              
              <table width="553" border="0" align="center">
                <tr>
                  <td width="157" height="37" bgcolor="#FF0000"><span class="style7 style2 style3"> <strong>Post Name :</strong></span></td>
                  <td width="386"><input required="required" type="text" name="pname" id="pname" /></td>
                </tr>
				<tr>
                  <td width="157" height="37" bgcolor="#FF0000"><span class="style7 style2 style3"> <strong>Post Uses :</strong></span></td>
                  <td width="386"><input required="required" type="text" name="puses" id="puses" /></td>
                </tr>
				<tr>
                  <td width="157" height="37" bgcolor="#FF0000"><span class="style7 style2 style3"> <strong>Post Description :</strong></span></td>
                  <td width="386"><textarea name="text" id="textarea" cols="25" rows="4"></textarea></td>
                </tr>
				<tr>
                  <td height="42" bgcolor="#FF0000" ><span class="style7 style2 style3"> <strong>Article Name :</strong> </span></td>
                  <td><input required="required" type="text" name="pspl" id="pspl" /></td>
                </tr>	
				<tr>
                  <td height="42" bgcolor="#FF0000" ><span class="style7 style2 style3"> <strong>Post Category :</strong> </span></td>
				...
				<tr>
            	   <td height="42" bgcolor="#FF0000" ><span class="style7 style2 style3"> <strong>Select Image :</strong> </span></td>
            		    <td><input name="pic" type="file" class="file " id="pic" required />                </td>
           		</tr>
				 <tr>
                <tr>
                  <td><div align="right"><span class="style8"></span></div></td>
                  <td><input type="submit" name="Submit" value="Encrypt & Upload Post" /></td>
                </tr>
              </table>
             
              <p>&nbsp;</p>
             </form>
             <div align="center"><a href="U_Main.jsp">Back</a></div>
             </div>
      <div class="sidebar">
