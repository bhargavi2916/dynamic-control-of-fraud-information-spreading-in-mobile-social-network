...
in Mobile Social Networks</big></span></a> </div>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
         <h2 align="center"><span class="style7">	List All Users and Follow</span> !! </h2>
         <p>&nbsp;</p>
		...
		<%
			...
			<tr>
             ...
             <tr> <td width="105" height="80" valign="middle" bgcolor="#FF0000" style="color:#000000;"><div align="center" class="style3"><strong>Name:</strong></div></td>
			 <td width="90" height="80" valign="middle" bgcolor="#FF0000" style="color:#000000;"><span class="style3">&nbsp;&nbsp;
              </span>
			   <div align="center" class="style4 style3"> <%out.println(s1);%> </div></td></tr>
				   <tr>
				    <td width="105" height="26" valign="middle" bgcolor="#FFFF00" style="color:#000000;"><div align="center" class="style5 style7"><strong>Status:</strong></div></td>
              <%
						if(status.equals("Already Friend")){
						%>
              <td  width="90" height="26"align="center" valign="middle" bgcolor="#FFFF00" style="color:#000000;"><span class="style5"><%=status %>&nbsp;</span></td>
              <%
						}else if(status.equals("sent")){
						%>
              <td  width="57" height="26"align="center" valign="middle" bgcolor="#FFFF00" style="color:#000000;"><span class="style5"><%=status %>&nbsp;</span></td>
              <%
						}else{
						
						%>
              <td  width="107" height="26"align="center" valign="middle" bgcolor="#FFFF00" style="color:#000000;"><a href="U_UpdateStatus.jsp?username=<%=s1%>&id=<%=i%>" class="style5"><%=status %>&nbsp;</a></td>
              <%}
						%>
            </tr>
            <%
