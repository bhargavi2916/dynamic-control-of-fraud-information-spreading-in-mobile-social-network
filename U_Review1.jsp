...
PreparedStatement pst=connection.prepareStatement("insert into reviews(pname,uploader,review,rew_by,dt) values(?,?,?,?,?)");
...
<span class="style4 style1"> Reviewed Successfully...</span>
