...
in Mobile Social Networksb</big></span></a> </div>
        <div class="clr"></div>
      </div>
      <div class="clr"></div>
    </div>
      ...
      <div class="mainbar">
         <h2><span class="style2">All Request and Response Details...</span></h2>
            ...
            <table width="600" border="3"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse;  margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
					<tr bgcolor="#99FF99">
					  <td  width="142" height="31" valign="baseline" bgcolor="#0000FF" style="color: #2c83b0;"><div align="center" class="style3">Username</div></td>
					  <td  width="141" height="31" valign="baseline" bgcolor="#0000FF" style="color: #2c83b0;"><div align="center" class="style3">Request Sent To </div></td>
  					
					  <td   width="115" height="31" valign="baseline" bgcolor="#0000FF" style="color: #2c83b0;"><div align="center" class="style3">Status</div></td>
					  <td  width="188" height="31" valign="baseline" bgcolor="#0000FF" style="color: #2c83b0;"><div align="center" class="style3">Date &amp; Time </div></td>
					</tr>
...
try 
{
	...
	while ( rs.next() )
	{
		...
		count++;
					%>
							<tr bgcolor="#FFFFFF">
								<td  width="142" height="35" valign="baseline" bgcolor="#FF0000" "><div align="center" class="style4"><span class="style6">&nbsp;&nbsp;
					            <%out.println(s1);%>
						        </span></div></td>	
								<td  width="141" height="35" valign="baseline" bgcolor="#FF0000"><div align="center" class="style4"><span class="style6">&nbsp;&nbsp;
					            <%out.println(s2);%>
						        </span></div></td>
								<td  width="115" height="35" valign="baseline" bgcolor="#FF0000"><div align="center" class="style4"><span class="style6">&nbsp;&nbsp;
					            <%out.println(s3);%>
						        </span></div></td>
							  <td  width="188" height="35" valign="baseline" bgcolor="#FF0000"><div align="center" class="style4"><span class="style6">&nbsp;&nbsp;
				              <%out.println(s4);%>
						      </span></div></td>
			  </tr>
					<%
