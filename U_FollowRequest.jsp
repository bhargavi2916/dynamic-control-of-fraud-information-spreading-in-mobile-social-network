...
in Mobile Social Networks</big></span></a> </div>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <h2><span class="style2">View All Follow Requests</span></h2>
        <p>&nbsp;</p>
        ...
        <tr>
          <td  width="176" height="125" valign="middle" bgcolor="#00FFFF" style="color: #2c83b0;"><div align="left" class="style4 style14 style7 style3" style="margin-left:20px;"><strong>Requested User </strong></div></td>
          <td  width="160" height="125" valign="middle" bgcolor="#FF0000" style="color:#000000;"><div align="left" class="style6 style10 style3 style3" style="margin-left:20px;">
              <%out.println(s1);%>
          </div></td>
        </tr>
        
        <tr>
         <td height="38" align="left" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="left " class="style14 style7 style4" style="margin-left:20px;">Status</div></td>
			  <%
			  if(s3.equalsIgnoreCase("waiting"))
			  {%>
			  	 <td height="38" align="left" valign="middle" bgcolor="#FF0000"><div align="left" class="style11 style4 style3" style="margin-left:20px;">
                       <a href="U_UpdateReq.jsp?id=<%=i%>&fname=<%=s1%>">Accept</a>
                      </div></td>
					  <%
					  }else
					  {
					  %><td  width="182" height="37" align="left" valign="middle" bgcolor="#FFFF00"><div align="left" class="style11 style4" style="margin-left:20px;"><%out.println(s3);}%></div></td>
        </tr>
        ...
        <%				}     		
					...
					if(count==0)
				{%> <h2><%out.print("There is No Follow Requests For You");%> <%}
					%>
      </table>
