...
<head>
<title>Mobile User Register Insert</title>
...
<%
  ...
  try 
  {
					...
					File file1 = null;	
					   ...
					   String bs="Unblocked";
						PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,dob,gender,address,location,bgroup,company,status,image,bstatus) values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
