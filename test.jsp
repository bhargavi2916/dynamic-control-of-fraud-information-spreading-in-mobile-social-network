  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		String Mobile User = (String)application.getAttribute("uname");
		
		  String query="select * from places where uname!='"+Mobile User+"' "; 
...
d2=rs.getString(12);
					   ...
					   String location1 = uname+" Visited "+pname+" Which Is in "+s3;
						...
						String str3="select * from hideinfo where locationinf='yes' and fromname='"+uname+"' and toname='"+Mobile User+"' "; 
